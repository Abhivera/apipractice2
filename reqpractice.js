...
app.get("/a",(req,res)=>{
  let abhi=req.body.name;
  let abhijit=req.body.age;
  res.json({abhi:abhi,abhijit:abhijit})

})
app.get("/b",(req,res)=>{
  let anil = req.query.character;
  let anilkant= req.query.type;
  res.json({anil,anilkant})
})
app.get("/c/:type/:character",(req,res)=>{
  let ayush =req.params.character;
  let deepchand = req.params.type;
  res.json({ayush,deepchand})
})
